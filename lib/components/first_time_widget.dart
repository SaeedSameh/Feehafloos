...
class FirstTimeWidget extends StatefulWidget {
  ...
  final FirstTimeRecord? firstData;
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              if (widget!.firstData?.image != null &&
                  widget!.firstData?.image != '')
                InkWell(
